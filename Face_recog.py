...
train_data_dir = 'photos_3/Train'
validation_data_dir = 'photos_3/Test'
...
stored_dict = {"[0]": "Pragya Mishra ", 
                      "[1]": "Sachin Mishra ",
                      "[2]": "Saumya",
                       }
stored_dict_n = {"[0]": "Pragya Mishra ", 
                      "[1]": "Sachin Mishra",
                      "[2]": "Saumya",
                      }
...
for i in range(0,10):
    input_im = getRandomImage("photos_3/Test/")
